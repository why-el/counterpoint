...
export function materials(renderer:THREE.WebGLRenderer) {
 ...
 return {env,
  brass:new THREE.MeshStandardMaterial({color:0xc2a064,metalness:.88,roughness:.29,roughnessMap:brush,envMapIntensity:1.1}),
  ...
  stone:new THREE.MeshStandardMaterial({color:0x273330,roughness:.8,metalness:.05}),
