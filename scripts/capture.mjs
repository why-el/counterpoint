...
await page.evaluate(()=>window.__counterpoint.capture?.());await page.screenshot({timeout:120000,path:process.argv[3]||'evidence/prototype/revised.png'});console.log(await page.evaluate(()=>window.__counterpoint.stats()));await browser.close();
